...
Class PDF extends TCPDF{
    ...
    public function setTitulo($titulo, $inicio, $fin, $producto, $productostr, $cajero, $cajerostr){
        $this->titulo=$titulo;
        $this->inicio=$inicio;
        $this->fin=$fin;
	...
	function Header(){
        ...
        $this->setX(102);
		$this->Cell(130, 10, utf8_decode($this->titulo), 0, 0, 'L');
        $this->SetFont(PDF_FONT_NAME_MAIN, 'B', 11);
        $this->Cell(40, 10, $this->cajerostr, 0, 1, 'C');
        $this->Cell(260, 10, $this->productostr, 0, 1, 'C');
		$this->Cell(260, 10, $subtitulo, 0, 1, 'C');
		$this->Ln(10);
        $this->SetX(20);
...
$miReporte->setTitulo($vista, $inicio, $fin, $producto, $productostr, $cajero, $cajerostr);
