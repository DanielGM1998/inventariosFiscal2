	...
	class DetsalidaModel {
		...
		public function getBySalida($id) {
			$salida = $this->db
				...
				->select(null)->select("$this->table.id_det_salida, $this->table.fk_producto, $this->table.cantidad, $this->table.peso, $this->table.importe,
        ...
        public function getRpt($inicio, $fin) {
			return $this->db->getPdo()->query(
				"SELECT $this->table.id_det_salida, $this->table.fk_salida, $this->table.fk_producto, $this->table.cantidad, $this->table.peso, $this->table.importe, $this->tableProd.descripcion, $this->tableS.fk_cliente,
        ...
        public function getRptCve($inicio, $fin, $cve) {
			...
			return $this->db->getPdo()->query(
				...
				SUM(REPLACE(peso,',','')) AS peso_total, SUM(REPLACE(importe,',','')) AS importe_total  
