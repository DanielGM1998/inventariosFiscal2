<?php
	...
	class EntradaProduccionModel {
		private $db;
		private $table = 'entrada_produccion';
		private $tableDE = 'det_entrada_produccion';
        ...
        public function getByDate($inicio, $fin) {
            return $this->db->getPdo()->query(
				"SELECT $this->table.id_entrada, $this->table.fecha, $this->table.peso_total, 
		...
		public function add($data) {
			...
			try{
				...
				$this->response->SetResponse(false, "catch: Add model entrada_produccion $ex");
			}
			return $this->response;
		}
		...
		public function edit($data, $id) {
			...
			try{
				...
				$this->response->errors = $ex;
				$this->response->SetResponse(false, "catch: Edit model entrada_produccion $ex");
			}
		}
